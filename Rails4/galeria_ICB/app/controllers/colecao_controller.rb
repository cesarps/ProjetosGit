class ColecaoController < ApplicationController
  ...
  def pesquisa
    ...
    if params[:data_inicio] != "" and params[:data_fim] != ""
      busca = "data_evento between '" + params[:data_inicio] + "' and '" + params[:data_fim] + "'"
    end
    ...
    if params[:nome_evento] != ""
      ...
      busca = busca + "nome_evento_assunto like '%" + params[:nome_evento] + "%'"
    end
    ...
    if !params[:departamento_id].empty?
      ...
      busca = busca + " departamento_id = " + params[:departamento_id].to_s
    end
